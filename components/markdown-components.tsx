...
export const markdownComponents: Components = {
  ...
  table: ({ children, ...props }) => (
    <div className="overflow-x-auto my-8 rounded-lg border border-gray-700 shadow-sm">
      <table className="min-w-full table-auto border-collapse text-sm text-gray-200" {...props}>
        {children}
      </table>
    </div>
  ),
  ...
  th: ({ children, ...props }) => (
    <th className="px-6 py-4 text-left font-semibold text-white whitespace-nowrap border-r border-gray-700 last:border-r-0" {...props}>
      {children}
    </th>
  ),
  td: ({ children, ...props }) => (
    <td className="px-6 py-4 align-top text-gray-300 border-t border-gray-700 border-r last:border-r-0" {...props}>
      {children}
    </td>
  ),
  ...
  // Headings
  h1: (props) => <h1 className="text-3xl font-bold mt-10 mb-4 text-white" {...props} />,
  h2: (props) => <h2 className="text-2xl font-semibold mt-8 mb-3 text-white" {...props} />,
  h3: (props) => <h3 className="text-xl font-medium mt-6 mb-2 text-white" {...props} />,
  h4: (props) => <h4 className="text-lg font-medium mt-6 mb-2 text-white" {...props} />,

  // Paragraphs and lists
  p: (props) => <p className="my-4 leading-relaxed text-gray-300" {...props} />,
  ul: (props) => <ul className="list-disc list-inside ml-6 my-4 text-gray-300" {...props} />,
  ol: ({ children, ...props }) => (
