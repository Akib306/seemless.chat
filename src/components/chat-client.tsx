	...
	return (
		<ChatProvider initialMessages={initialMessages} chatId={chatId}>
			<div className="h-screen w-full flex flex-col overflow-hidden bg-background">
                ...
                */}
				<div className="flex-shrink-0 sticky bottom-0 left-0 w-full bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 z-10 border-t border-border">
					<ChatInput />
				</div>
			</div>
		</ChatProvider>
