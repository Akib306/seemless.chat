			...
			<div className="group-data-[collapsible=icon]:hidden">
				<DropdownMenu>
					<DropdownMenuTrigger asChild>
						<button className="w-full flex items-center justify-between gap-2 rounded-xl px-0 py-2 bg-transparent border border-transparent transition-colors text-foreground-secondary hover:bg-sidebar-accent/40">
