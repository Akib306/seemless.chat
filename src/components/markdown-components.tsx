...
export const markdownComponents: Components = {
	...
	p: (props) => (
		<p className="my-3 leading-7 text-gray-200/90 break-words" {...props} />
	),
	ul: ({ children, ...props }) => (
		<ul
			className="list-disc list-outside ml-6 my-4 space-y-2 text-gray-200/90"
			{...props}
		>
			{children}
		</ul>
	...
	ol: ({ children, ...props }) => (
		<ol
			className="list-decimal list-outside ml-6 my-3 space-y-2 text-gray-200/90"
			{...props}
		>
			{children}
		</ol>
